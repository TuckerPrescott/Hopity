...
public:
    ...
    void switchScene(const CCString &link, bool pause = false, bool restart = false, PTPScreensController::ScoresOperation scoresOperation = PTPScreensController::NoSaveScoresOperation);
